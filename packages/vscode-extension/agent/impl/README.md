...
| F28 | Workspace-Scoped Profiles (one profile per folder, no bleed between workspaces) | Phase 1 | `planned` | [impl-f28-workspace-scoped-profiles.prompt.md](impl-f28-workspace-scoped-profiles.prompt.md) |
