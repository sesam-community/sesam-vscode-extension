...
| F29 | Large Workspace Optimization (1k+ pipes) | Cross-cutting | `phase 1 implemented` | [large-workspace-optimization.prompt.md](../plans/large-workspace-optimization.prompt.md) |
